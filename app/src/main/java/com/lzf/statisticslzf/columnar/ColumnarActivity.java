...
public class ColumnarActivity extends AppCompatActivity implements View.OnClickListener {
    CombineChart combineChart;
    String[] rightYLabels; //右边的y轴
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data.add(new BarChartBean("7/11", 846)); //, 111, 444
        data.add(new BarChartBean("7/12", 846)); //, 111, 444
        data.add(new BarChartBean("7/13", 846)); //, 111, 444
        data.add(new BarChartBean("7/14", 846)); //, 111, 444
        ...
        combineChart.setOnItemBarClickListener(new CombineChart.OnItemBarClickListener() {
            ...
            public void onClick(int position) {
                Toast.makeText(ColumnarActivity.this, "点击了：" + position, Toast.LENGTH_SHORT).show();
            }
        });
